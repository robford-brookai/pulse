...
- [task-001.md](handoffs/pulse-demo-closeout/task-001.md)
- [task-002.md](handoffs/pulse-demo-closeout/task-002.md)
...
3. Run `openspec validate pulse-demo-closeout` to check format.
