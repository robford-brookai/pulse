# Handoff Summary: s12-verdict-relay

Collected 1 handoff(s).

## Files

- [s12-task-007.md](handoffs/s12-verdict-relay/s12-task-007.md)

## Doc-Updater Instructions

1. Read each handoff file above.
2. For each spec-relevant update, edit the corresponding file in:
   `openspec/changes/s12-verdict-relay/specs/`
3. Run `openspec validate s12-verdict-relay` to check format.
