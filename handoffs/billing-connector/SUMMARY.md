...
- [bc-task-001.md](handoffs/billing-connector/bc-task-001.md)

## Doc-Updater Instructions

1. Read each handoff file above.
2. For each spec-relevant update, edit the corresponding file in:
   `openspec/changes/billing-connector/specs/`
3. Run `openspec validate billing-connector` to check format.
