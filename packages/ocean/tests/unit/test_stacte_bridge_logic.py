...
from src.embedder import entity_to_text  # noqa: E402


def test_alert_entity_to_text_contains_severity_and_type():
    text = entity_to_text("alerts", {
        "alert_id": "a1", "patient_id": "patient-12345678",
        "alert_type": "glucose_high", "severity": "URGENT",
...
def test_task_entity_to_text_contains_type_and_priority():
    text = entity_to_text("tasks", {
        "task_id": "t1", "task_type": "outreach",
        "priority": "high", "status": "claimed", "alert_id": "alert-abcdefgh",
    })
...
def test_outcome_entity_to_text_contains_type_and_resolution():
    text = entity_to_text("outcomes", {
        "outcome_id": "o1", "outcome_type": "call_completed",
        "resolution_status": "resolved", "notes": None,
    })
